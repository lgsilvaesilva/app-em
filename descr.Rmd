...
```{r tidy=FALSE, prompt=TRUE, comment="", highlight=TRUE, message=F}
...
```{r tidy=FALSE, prompt=TRUE, comment="", highlight=TRUE, message=FALSE, fig.align='center'}
...
```{r tidy=FALSE, prompt=TRUE, comment="", highlight=TRUE, message=FALSE, fig.align='center', fig.width=18}
